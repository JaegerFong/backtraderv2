...
from . import Indicator, Max, MovAv, Highest, Lowest, DivByZero,ExponentialMovingAverage,MovingAverageSimple


class _StochasticBase(Indicator):
    lines = ('percK', 'percD',)
    params = (('period', 9), ('period_dfast', 3), ('movav', MovingAverageSimple),
